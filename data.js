...
let SQUAD_QUESTS = [
  { id: 1, title: 'Spring Break Trip', target: 2000, current: 850, members: ['Alex', 'Sarah', 'James'], icon: '🌴' },
  { id: 2, title: 'Graduation Party', target: 500, current: 120, members: ['Alex', 'Emily'], icon: '🎓' },
];
...
let LEADERBOARD = [
  ...
  { name: 'Alex Johnson', score: 450, avatar: 'AJ', color: '#4f8ef7', isMe: true },
